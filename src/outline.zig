...
pub fn outlineIcon(src: std.builtin.SourceLocation, comptime icon: Outline, icon_opts: dvui.IconRenderOptions, opts: dvui.Options) void {
    widget.iconWidget(src, .outline, @tagName(icon), svg(icon), icon_opts, opts);
}
///
...
pub fn outlineIconButton(src: std.builtin.SourceLocation, comptime icon: Outline, init_opts: dvui.ButtonWidget.InitOptions, icon_opts: dvui.IconRenderOptions, opts: dvui.Options) bool {
    return widget.iconButtonWidget(src, .outline, @tagName(icon), svg(icon), init_opts, icon_opts, opts);
}
